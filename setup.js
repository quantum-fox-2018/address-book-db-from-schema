...
class Database{
  ...
  static setup(cbSetupMessage){
    ...
    db.serialize(function() {
      ...
      let createTableGroup = "CREATE TABLE IF NOT EXISTS groups (id INTEGER PRIMARY KEY AUTOINCREMENT,groupName VARCHAR(20))"
      let createTableGroupContact = "CREATE TABLE IF NOT EXISTS group_contacts (id INTEGER PRIMARY KEY AUTOINCREMENT,groupId INTEGER REFERENCES groups(id), contactId INTEGER REFERENCES contacts(id))"
